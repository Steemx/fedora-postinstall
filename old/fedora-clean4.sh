...
# Permitir que el script continúe si fallan comandos secundarios
set +e
...
# Prioridad para evitar conflictos con paquetes de repositorios base
echo "priority=1" | tee -a /etc/yum.repos.d/_copr:copr.fedorainfracloud.org:yalter:niri-git.repo

# Aseguramos la instalación de SDDM primero
...
# SEGURO CRÍTICO PARA SDDM: Desactivar otros gdm/lightdm e instalar a la fuerza el enlace
systemctl disable gdm.service 2>/dev/null || true
systemctl disable lightdm.service 2>/dev/null || true
systemctl enable --force sddm.service
log_status $? "Base Niri/Noctalia (Git) y activación forzada de SDDM"
...
echo "=== 10. Configurando Firewall y Teclado ==="
...
EOF
log_status $? "Configuración de firewall y teclado"
...
log_status $? "Instalación de programas DNF"
...
echo "Generando initramfs con Dracut (esto puede tardar)..."
/usr/sbin/dracut --force --verbose || echo "⚠️ Dracut lanzó advertencias, continuando..."
